 ...
 */
public class WLGsonHttpMessageConverter   extends AbstractHttpMessageConverter<Object> {
     ...
     */
    public WLGsonHttpMessageConverter() {
        this(new Gson());
    }
     ...
     */
    public WLGsonHttpMessageConverter(boolean serializeNulls) {
     ...
     * Construct a new {@code GsonHttpMessageConverter}.
     *
     * @param gson a customized {@link com.google.gson.Gson#Gson() Gson}
     */
    public WLGsonHttpMessageConverter(Gson gson) {
     ...
     * {@link com.google.gson.Gson#Gson() Gson} is used.
